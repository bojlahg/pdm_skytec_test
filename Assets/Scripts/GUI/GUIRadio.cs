...
public class GUIRadio : GUIControl
{
    ...
    public override void Init()
    {
        ...
        {
            GUIRadioGroup grp = transform.parent.GetComponent<GUIRadioGroup>();
            if(grp != null)
            {
                m_Toggle.group = grp.toggleGroup;
            }
        }
    }
    ...
    public void SetGroup(GUIRadioGroup rg)
    {
